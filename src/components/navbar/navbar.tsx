...
const NavigationBar = () => {
  ...
  return (
    <header
      className={`z-50 fixed top-0 left-0 right-0 h-[60px] ${nav_bg} transition-all duration-300`}
    >
      <nav className="flex justify-between w-full max-w-[1280px] m-auto h-[60px] items-center text-white">
        ...
        <div className="h-full justify-between">
          ...
          <ul className="nav_items h-full">
            <li
              className={`w-[160px] h-full flex items-center justify-center hover:drop-shadow-white-lg font-pretendard ${
            ...
            <li
              className={`w-[160px] h-full flex items-center justify-center hover:drop-shadow-white-lg font-pretendard ${
                pathname.startsWith("/notice") && " active"
              }`}
            ...
            <li
              className={`wiki w-[160px] h-full flex items-center justify-center hover:drop-shadow-white-lg font-pretendard ${
                pathname.startsWith("/wiki") && " active"
              }`}
            ...
            <li
              className={`login w-[160px] h-full flex items-center justify-center hover:drop-shadow-white-lg font-pretendard ${
