            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {notices && notices.map((notice) => (
                        <div key={notice.id} className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1 border-t-2 border-blue-400">
                            <div className="p-6">
